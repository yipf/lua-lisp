...
eval=function(obj,env,level)
	...
	-- nomal processing
	for i,v in ipairs(obj) do obj[i]=eval(v,env,level+1) 	print(string.rep("\t|",level),"eval:",obj2sexp(v),"=>",obj2sexp(obj[i]))end
	first=obj[1]
